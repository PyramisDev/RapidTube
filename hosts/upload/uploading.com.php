...
$not_done=true;
$continue_up=false;
if (isset($upload_acc) && isset($upload_acc["uploading_com"]['user']) && $upload_acc["uploading_com"]['user'] != '' && $upload_acc["uploading_com"]['pass'] != '') {
	$_REQUEST['my_login'] = $upload_acc["uploading_com"]['user'];
	$_REQUEST['my_pass'] = $upload_acc["uploading_com"]['pass'];
