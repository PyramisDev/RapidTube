...
if (isset($upload_acc) && isset($upload_acc["filesonic_com"]['user']) && $upload_acc["filesonic_com"]['user'] != '' && $upload_acc["filesonic_com"]['pass'] != '') {
    $_REQUEST['my_login'] = $upload_acc["filesonic_com"]['user'];
    $_REQUEST['my_pass'] = $upload_acc["filesonic_com"]['pass'];
    ...
    $_REQUEST['action'] = "FORM";
    echo "<b><center>Use Premium login/pass.</center></b>\n";
}
