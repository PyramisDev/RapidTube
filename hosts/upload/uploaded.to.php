<?php
	...
	$not_done = true;
	$continue_up = false;
				if (isset($upload_acc) && isset($upload_acc["uploaded_to"]['user']) && $upload_acc["uploaded_to"]['user'] != '' && $upload_acc["uploaded_to"]['pass'] != '') {
					$_REQUEST['ud_user'] = $upload_acc["uploaded_to"]['user'];
					$_REQUEST['ud_pass'] = $upload_acc["uploaded_to"]['pass'];
