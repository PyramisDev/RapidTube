<!-- RapidTube mod by Damian Van der Weide, Alias DMC -->
<?php
...
<!-- Load Bootstrap -->
<link title="RapidTube Style" href="templates/RapidTube/styles/bootstrap.css" rel="stylesheet" type="text/css" />
<!-- Load FlatUI -->
<link title="RapidTube Style" href="templates/RapidTube/styles/rl_style_pm.css" rel="stylesheet" type="text/css" />
<title><?php
if (!isset($nn)) $nn = "\r\n";
if (!isset($page_title)) {
	echo 'RapidTube v1 rev. '.$rev_num;
} else {
